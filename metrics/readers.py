...
def read_daily_metrics(redis, utc_date: date) -> dict:
    ...
    return {
        ...
        MetricName.EMAILS_SENT_SUCCESS: get_int(MetricName.EMAILS_SENT_SUCCESS),
        MetricName.EMAILS_SENT_FAILURE: get_int(MetricName.EMAILS_SENT_FAILURE),
        MetricName.EMAIL_SEND_RETRIES: get_int(MetricName.EMAIL_SEND_RETRIES),
        MetricName.EMAIL_SEND_PERMANENT_FAILURE: get_int(MetricName.EMAIL_SEND_PERMANENT_FAILURE),
